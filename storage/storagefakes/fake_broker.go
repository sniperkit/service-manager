...
type FakeBroker struct {
	CreateStub        func(broker *rest.Broker) error
	...
	GetStub        func(id string) (*rest.Broker, error)
	...
	GetAllStub        func() ([]rest.Broker, error)
	...
	UpdateStub        func(broker *rest.Broker) error
...
func (fake *FakeBroker) Create(broker *rest.Broker) error {
...
func (fake *FakeBroker) CreateArgsForCall(i int) *rest.Broker {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
...
func (fake *FakeBroker) Get(id string) (*rest.Broker, error) {
	fake.getMutex.Lock()
...
func (fake *FakeBroker) GetReturns(result1 *rest.Broker, result2 error) {
	fake.GetStub = nil
...
func (fake *FakeBroker) GetReturnsOnCall(i int, result1 *rest.Broker, result2 error) {
	fake.GetStub = nil
...
func (fake *FakeBroker) GetAll() ([]rest.Broker, error) {
...
func (fake *FakeBroker) GetAllReturns(result1 []rest.Broker, result2 error) {
	fake.GetAllStub = nil
...
func (fake *FakeBroker) GetAllReturnsOnCall(i int, result1 []rest.Broker, result2 error) {
	fake.GetAllStub = nil
...
func (fake *FakeBroker) Update(broker *rest.Broker) error {
...
func (fake *FakeBroker) UpdateArgsForCall(i int) *rest.Broker {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
