...
func (ctrl *Controller) addPlatform(request *filter.Request) (*filter.Response, error) {
...
func (ctrl *Controller) getPlatform(request *filter.Request) (*filter.Response, error) {
...
func (ctrl *Controller) getAllPlatforms(request *filter.Request) (*filter.Response, error) {
...
func (ctrl *Controller) deletePlatform(request *filter.Request) (*filter.Response, error) {
	platformID := request.PathParams[reqPlatformID]
...
func (ctrl *Controller) updatePlatform(request *filter.Request) (*filter.Response, error) {
	platformID := request.PathParams[reqPlatformID]
